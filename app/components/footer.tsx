...
//                     {/* Company Info */}
//                     <div>
//                         <h3 className="text-xl font-bold mb-4 font-playfair">Midnight Matchalotte</h3>
//                         <p className="mb-4">Premium coffee and tea experiences since 2015.</p>
//                         <div className="flex space-x-4">
//                             <a href="#" className="hover:text-matcha transition">
...
//                             <li><a href="#" className="hover:text-matcha transition">Coffee</a></li>
//                             <li><a href="#" className="hover:text-matcha transition">Tea</a></li>
//                             <li><a href="#" className="hover:text-matcha transition">Pastries</a></li>
//                             <li><a href="#" className="hover:text-matcha transition">Seasonal Specials</a></li>
//                         </ul>
//                     </div>
...
//                         <ul className="space-y-2">
//                             <li><a href="#" className="hover:text-matcha transition">Downtown</a></li>
//                             <li><a href="#" className="hover:text-matcha transition">Midtown</a></li>
//                             <li><a href="#" className="hover:text-matcha transition">Uptown</a></li>
//                             <li><a href="#" className="hover:text-matcha transition">Westside</a></li>
//                         </ul>
//                     </div>
...
//                         <p className="mb-4">Subscribe to get updates on new drinks and promotions.</p>
//                         <div className="flex">
//                             <input
//                                 type="email"
...
//                             />
//                             <button className="bg-matcha text-coffee px-4 py-2 rounded-r font-bold">
//                                 Join
//                             </button>
//                         </div>
//                     </div>
...
//                     <p>&copy; {new Date().getFullYear()} Midnight Matchalotte. All rights reserved.</p>
//                 </div>
//             </div>
//         </footer>
//     );
